...
},{"./core/DiagonalMovement":10,"./core/Grid":11,"./core/Heuristic":12,"./core/Node":13,"./core/Util":14,"./finders/AStarFinder":15,"./finders/BestFirstFinder":16,"./finders/BiAStarFinder":17,"./finders/BiBestFirstFinder":18,"./finders/BiBreadthFirstFinder":19,"./finders/BiDijkstraFinder":20,"./finders/BreadthFirstFinder":21,"./finders/DijkstraFinder":22,"./finders/IDAStarFinder":23,"./finders/JumpPointFinder":28,"heap":6}],10:[function(require,module,exports){
...
},{"./DiagonalMovement":10,"./Node":13}],12:[function(require,module,exports){
/**
...
},{"../core/DiagonalMovement":10,"../core/Heuristic":12,"../core/Util":14,"heap":6}],16:[function(require,module,exports){
...
},{"../core/DiagonalMovement":10,"../core/Heuristic":12,"../core/Util":14,"heap":6}],18:[function(require,module,exports){
...
},{"../core/DiagonalMovement":10,"../core/Util":14}],20:[function(require,module,exports){
var BiAStarFinder = require('./BiAStarFinder');
...
},{"../core/DiagonalMovement":10,"../core/Util":14}],22:[function(require,module,exports){
var AStarFinder = require('./AStarFinder');
...
},{"../core/DiagonalMovement":10,"../core/Heuristic":12,"../core/Node":13,"../core/Util":14}],24:[function(require,module,exports){
/**
...
},{"../core/DiagonalMovement":10,"./JumpPointFinderBase":29}],25:[function(require,module,exports){
/**
 * @author imor / https://github.com/imor
 */
var JumpPointFinderBase = require('./JumpPointFinderBase');
...
},{"../core/DiagonalMovement":10,"./JumpPointFinderBase":29}],26:[function(require,module,exports){
/**
 * @author imor / https://github.com/imor
 */
var JumpPointFinderBase = require('./JumpPointFinderBase');
...
},{"../core/DiagonalMovement":10,"./JumpPointFinderBase":29}],27:[function(require,module,exports){
/**
 * @author imor / https://github.com/imor
 */
var JumpPointFinderBase = require('./JumpPointFinderBase');
...
},{"../core/DiagonalMovement":10,"./JumpPointFinderBase":29}],28:[function(require,module,exports){
/**
...
},{"../core/DiagonalMovement":10,"./JPFAlwaysMoveDiagonally":24,"./JPFMoveDiagonallyIfAtMostOneObstacle":25,"./JPFMoveDiagonallyIfNoObstacles":26,"./JPFNeverMoveDiagonally":27}],29:[function(require,module,exports){
/**
 * @author imor / https://github.com/imor
 */
var Heap       = require('heap');
...
},{"../core/DiagonalMovement":10,"../core/Heuristic":12,"../core/Util":14,"heap":6}],30:[function(require,module,exports){
'use strict';
...
var _anypixel$config = anypixel.config;
var width = _anypixel$config.width;
var height = _anypixel$config.height;

var game = new _game2.default(ctx, width, height);
...
},{"./game":33,"anypixel":1}],31:[function(require,module,exports){
'use strict';
...
var colors = ['#2ecc71', '#27ae60', '#3498db', '#2980b9', '#1abc9c', '#16a085', '#e67e22', '#e74c3c'];
...
var Fish = function () {
  ...
  _createClass(Fish, [{
    ...
    key: 'notify',
    value: function notify(coords) {
      this.hungry = true;
      console.log('Hungry! ' + this.hungry);
      var x = parseInt(this.coords.x, 10);
      var y = parseInt(this.coords.y, 10);
    ...
    key: 'navigateToFood',
    value: function navigateToFood() {
      var x = parseInt(this.coords.x, 10);
      var y = parseInt(this.coords.y, 10);

      var nextStep = this.path.shift();
...
},{"pathfinding":8}],32:[function(require,module,exports){
"use strict";
...
var Game = function () {
  function Game(ctx, width, height) {
    ...
    for (var i = 0; i < MAX_FISHES; i++) {
      this.fishes.push(new _fish2.default(this.ctx, { width: width, height: height }));
    }
  ...
  _createClass(Game, [{
    ...
    value: function render() {
      ...
      this.foods.forEach(function (food) {
        return _this2.drawFood(food);
      });
    }
  }, {
    key: 'setFood',
    value: function setFood(ev) {
      var food = new _food2.default(ev);
